...
![Norway_wind_farms](https://github.com/user-attachments/assets/95171589-e6da-4c4f-bb81-14f7ec7dd6ff)
...
- `apirequirements.txt` – Python dependencies
- `Powermodel.ipynb` - Model Training and Evaluation
